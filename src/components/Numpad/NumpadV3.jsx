...
export default function NumpadV3({ submit }) {
    ...
    return (
        <div className="sl-numpad">
            <div className="sl-numpad__option-container gap-1">
                <div className={`sl-numpad__option ${options.includes('วิ่งบน') && 'sl-numpad__option--active'}`} onClick={() => handleOptionChange('วิ่งบน')}>วิ่งบน</div>
                <div className={`sl-numpad__option ${options.includes('วิ่งล่าง') && 'sl-numpad__option--active'}`} onClick={() => handleOptionChange('วิ่งล่าง')}>วิ่งล่าง</div>
